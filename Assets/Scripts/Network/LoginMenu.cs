...
// Log out and log in need move to UserAccountManeger
...
public class LoginMenu : MonoBehaviour {
    ...
    #region IEnumerators for Coroutine
    //Called by Button Pressed Methods. These use DatabaseControl namespace to communicate with server.
    IEnumerator LoginUser ()
    {
        IEnumerator e = UserAccountManager.instance.LoginUserRequest(Login_UsernameField.text, Login_PasswordField.text); // << Send request to login, providing username and password
        while (e.MoveNext())
        {
        ...
        if (response == "Success")
        {
            ...
            UserAccountManager.instance.SuccessLogInChangeScene();
            ...
            //LoggedIn_DisplayUsernameText.text = "Logged In As: " + UserAccountManager.playerUsername;
        } else
        {
    ...
    //IEnumerator GetData ()
    //{
    //    IEnumerator e = UserAccountManager.instance.GetDataRequest(); // << Send request to get the player's data string. Provides the username and password
    //    while (e.MoveNext())
    //    {
    //        yield return e.Current;
    //    }
    ...
    //{
    //    IEnumerator e = UserAccountManager.instance.SendDataRequest(data); // << Send request to set the player's data string. Provides the username, password and new data string
    //    while (e.MoveNext())
    //    {
    //        yield return e.Current;
    //    }
